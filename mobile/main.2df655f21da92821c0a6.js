! function(t) {
    ...
    var w = function() {
        ...
        _ = function() {
            function t(e) {
                ...
                s(this, t), this._c = {}, this._t = [], this._e = new w, this.disabled = !1, this.selector = e, this.settings = y(i, n), this.index = this.settings.startAt
            }
            return u(t, [{
                key: "mount",
                value: function() {
    ...
    var q = {
            Html: function(t, e) {
                ...
                return b(n, "root", {
                    ...
                    set: function(t) {
                        d(t) && (t = document.querySelector(t)), H(t) ? n._r = t : r("Root element must be a existing Html node")
                    }
                }), b(n, "track", {
                    get: function() {
                        return n._t
                    ...
                    set: function(t) {
                        H(t) ? n._t = t : r('Could not find track element. Please use [data-glide-el="track"] attribute.')
                    }
                }), b(n, "wrapper", {
                    get: function() {
            ...
            Direction: function(t, e, n) {
                ...
                return b(i, "value", {
                    ...
                    set: function(t) {
                        L.indexOf(t) > -1 ? i._v = t : r("Direction value must be `ltr` or `rtl`")
                    }
                ...
                var i = {
                    apply: function(t) {
                        for (var n = 0, i = t.length; n < i; n++) {
                            var r = t[n].style,
                                o = e.Direction.value;
                            r[x[o][0]] = 0 !== n ? this.value / 2 + "px" : "", n !== t.length - 1 ? r[x[o][1]] = this.value / 2 + "px" : r[x[o][1]] = ""
                        }
                    },
                    remove: function(t) {
                        ...
                        move: function(i) {
                            if (!t.disabled) {
                                var u = t.settings,
                                    ...
                                    g = Math.sqrt(p + m),
                                    b = Math.sqrt(m);
                                if (!(180 * (r = Math.asin(b / g)) / Math.PI < a)) return !1;
        ...
        V = function(t) {
            ...
            return function(t, e) {
                ...
                value: function() {
                    var t = arguments.length > 0 && void 0 !== arguments[0] ? arguments[0] : {};
                    return c(e.prototype.__proto__ || Object.getPrototypeOf(e.prototype), "mount", this).call(this, a({}, q, t))
                }
            }]), e
        }(_),
        F = document.getElementsByClassName("hamburger"),
        Y = document.getElementsByClassName("navigation__content");
    F[0] && Y && F[0].addEventListener("click", (function() {
        F[0].classList.toggle("hamburger--active"), F[0].setAttribute("aria-expanded", "false" === F[0].getAttribute("aria-expanded") ? "true" : "false"), Y[0].classList.toggle("navigation__content--active"), Y[0].classList.remove("navigation__content--initial"), document.body.classList.toggle("disable-scroll")
    }));
    var X = document.getElementById("processSprint"),
        K = document.getElementById("aboutTeam");
    (X || K) && window.addEventListener("DOMContentLoaded", (function() {
        new V(".glide", {
            gap: 0,
            peek: {
                before: 0,
    ...
    var J = function() {
        window.innerWidth > 992 ? document.body.classList.add("disable-scroll") : document.body.classList.remove("disable-scroll")
    };
    document.addEventListener("resize", J), document.addEventListener("DOMContentLoaded", J)
}]);